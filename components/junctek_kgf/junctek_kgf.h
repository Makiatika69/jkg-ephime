...
public:
  ...
  void set_battery_remain_cap_sensor(sensor::Sensor *battery_remain_cap_sensor) { battery_remain_cap_sensor_ = battery_remain_cap_sensor; }
...
protected:
  ...
  sensor::Sensor* battery_remain_cap_sensor_{nullptr};
